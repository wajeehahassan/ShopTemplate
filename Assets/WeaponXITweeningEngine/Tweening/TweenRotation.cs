...
public class TweenRotation : UITweener
{
    ...
    public Vector3 from;
    public Vector3 to;
    public bool quaternionLerp = false;         // Spherical lerp For slow in and slow out effect

    Transform mTrans;


    public Transform cachedTransform { get { if (mTrans == null) mTrans = this.transform; return mTrans; } }
